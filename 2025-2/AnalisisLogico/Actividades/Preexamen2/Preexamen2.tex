...
\begin{enumerate}[I.]
    ...
    \begin{enumerate}[1.]
        ...
        { \color{azul}
            ...
            \begin{tabular}{l|l}
                \textbf{Alcance} & $\forall x:P(x) \rightarrow Q(x)$ \\
                \hline
                $FV(\varphi)$ & \emptyset \\
                \hline
                $LV(\varphi)$ & $x$
        ...
        { \color{azul}
            \renewcommand{\arraystretch}{1.5}
            \begin{tabular}{l|l}
                \textbf{Alcance} & $\exists y: P(y,z)$ \\
                \hline
                $FV(\varphi)$ & $z$ \\
                \hline
                $LV(\varphi)$ & $y$ \\
                \hline
                $Cl_{\exists}$ & $\exists z \exists y P(y,z)$ \\
                \hline
                $Cl_{\forall}$ & $\forall z \exists y P(y,z)$
            \end{tabular}
        }
        ...
        { \color{azul}
            \renewcommand{\arraystretch}{1.5}
            \begin{tabular}{l|l}
                \textbf{Alcance} & $\forall x: P(x) \land \forall y Q(y)$, $\forall y: Q(y)$\\
                \hline
                $FV(\varphi)$ & $\emptyset$ \\
                \hline
                $LV(\varphi)$ & $x$, $y$ \\
        ...
        { \color{azul}
            \renewcommand{\arraystretch}{1.5}
            \begin{tabular}{l|l}
                \textbf{Alcance} & $\forall x: P(y) \rightarrow \exists y (Q(y) \land R(x,y))$, $\exists y: Q(y) \land R(x,y)$\\
                \hline
                $FV(\varphi)$ & $y$\\
                \hline
                $LV(\varphi)$ & $x$, $y$\\
                \hline
                $Cl_{\exists}$ & $\exists y \forall x (P(y) \rightarrow \exists z (Q(z) \land R(x,z)))$ \\
                \hline
                $Cl_{\forall}$ & $\forall y \forall x (P(y) \rightarrow \exists z (Q(z) \land R(x,z)))$ 
            \end{tabular}
        }
        ...
        { \color{azul}
            \renewcommand{\arraystretch}{1.5}
            \begin{tabular}{l|l}
                \textbf{Alcance} & $\exists x: R(x,y) \rightarrow R(y,x)$, $\forall y: R(x,y) \rightarrow R(y,x)$ \\
                \hline
                $FV(\varphi)$ & $\emptyset$ \\
                \hline
                $LV(\varphi)$ & $x$, $y$ \\
        ...
        { \color{azul}
            \renewcommand{\arraystretch}{1.5}
            \begin{tabular}{l|l}
                \textbf{Alcance} & $\forall x: P(f(x)) \lor \exists y Q(g(y), x)$, $\exists y: Q(g(y), x)$ \\
                \hline
                $FV(\varphi)$ & $\emptyset$ \\
                \hline
                $LV(\varphi)$ & $x$, $y$ \\
        ...
        { \color{azul}
            \renewcommand{\arraystretch}{1.5}
            \begin{tabular}{l|l}
                \textbf{Alcance} & $\exists z: \forall x P(x,z) \rightarrow \exists x Q(x,z)$, $\forall x: P(x,z)$, $\exists x: Q(x,z)$ \\
                \hline
                $FV(\varphi)$ & $\emptyset$ \\
                \hline
                $LV(\varphi)$ & $x$, $z$ \\
        ...
        { \color{azul}
            \renewcommand{\arraystretch}{1.5}
            \begin{tabular}{l|l}
                \textbf{Alcance} & $\forall x$: $P(x, f(y))$ \\
                \hline
                $FV(\varphi)$ & $y$ \\
                \hline
                $LV(\varphi)$ & $x$ \\
                \hline
                $Cl_{\exists}$ & $\exists y (\forall x P(x, f(y)))$ \\
                \hline
                $Cl_{\forall}$ & $\forall y (\forall x P(x, f(y)))$
            \end{tabular}
        }
        ...
        { \color{azul}
            \renewcommand{\arraystretch}{1.5}
            \begin{tabular}{l|l}
                \textbf{Alcance} & $\exists x: Q(x) \land \forall y (x = y \rightarrow P(y))$, $\forall y: x = y \rightarrow P(y)$ \\
                \hline
                $FV(\varphi)$ & $\emptyset$ \\
                \hline
                $LV(\varphi)$ & $x$, $y$ \\
        ...
        { \color{azul}
            \renewcommand{\arraystretch}{1.5}
            \begin{tabular}{l|l}
                $\alpha$-renombrar & $\exists y (R(y) \land \forall x (P(x,y) \rightarrow \exists z Q(x,z)))$ \\
                \hline
                \textbf{Alcance} & $\exists y: R(y) \land \forall x (P(x,y) \rightarrow \exists z Q(x,z))$, $\forall x: P(x,y) \rightarrow \exists z Q(x,z)$, $\exists z: Q(x,z)$ \\
                \hline
                $FV(\varphi)$ & $\emptyset$ \\
                \hline
                $LV(\varphi)$ & $x$, $y$, $z$ \\
    ...
    \begin{enumerate}[1.]
        ...
        { \color{azul} 
            \begin{itemize}
                \item $D = \{x | x = 2k, k \in \mathbb{N}\}$
                \item $P(x) \coloneqq$ ``$x$ es menor que 4"
                \item $Q(x) \coloneqq$ ``$x$ es par"
            \end{itemize}
        }
