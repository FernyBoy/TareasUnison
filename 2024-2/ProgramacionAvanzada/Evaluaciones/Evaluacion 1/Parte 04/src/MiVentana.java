...
public class MiVentana extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int ancho = (int) (Pantalla.width * Math.random());
        int alto = (ancho * 9) / 16;
        int x = (int) (Pantalla.width * Math.random());
        int y = (int) (Pantalla.height * Math.random());
        
        this.setSize(ancho, alto);
        this.setLocation(x, y);
        
        jLabel1.setText( String.valueOf(Math.random() * rand.nextDouble(100)));
