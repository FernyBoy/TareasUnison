...
%====================
\section*{Education}
\textbf{Universidad de Sonora} \hfill GPA: 91.91\%\\
...
%====================
\textbf{TE Connectivity} \hfill AI Engineering\\
AI Engineer Intern \hfill \textbf{June 2026 -- September 2026}
\vspace{-0.3cm}
\begin{itemize}[leftmargin=*]
    \item Installed and configured a shared development server for interns, establishing the infrastructure and user access needed to provide a centralized environment for developing and hosting their projects.
    
    \vspace{-0.3cm}
    \item Migrated the orchestration workflow of an AI agent to LangGraph, restructuring its state management and execution flow to improve maintainability and efficiency.
    
    \vspace{-0.3cm}
    \item Reworked the agent's internal architecture and execution flow, reducing response times from up to three minutes to near-instant responses and improving the system's usability.
    
    \vspace{-0.3cm}
    \item Collaborated with project stakeholders to adapt and improve an AI-based system for continued use, translating technical requirements into maintainable software components and workflows.
\end{itemize}
